...
const EditPrestasi = () => {
  ...
  return (
    <>
      <div>
        <Link to="/prestasi" className='rounded-lg border text-white py-2 px-3 bg-blue-500'>Kembali</Link>
        <div className='flex justify-center text-2xl font-bold'>Edit Data Prestasi Siswa</div>
      </div>
